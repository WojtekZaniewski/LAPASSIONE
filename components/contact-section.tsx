...
export function ContactSection() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="snap-section h-screen w-full bg-primary text-primary-foreground opacity-0 flex items-center justify-center">
