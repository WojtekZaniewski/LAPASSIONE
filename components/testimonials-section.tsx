...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" ref={sectionRef} className="snap-section h-screen w-screen bg-background opacity-0 flex items-center justify-center overflow-hidden">
